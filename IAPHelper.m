...
- (id)initWithProductIdentifiers:(NSSet *)productIdentifiers {
    ...
    if ((self = [super init])) {
        ...
        // You will be notified about any transactions that were never quite finished 
...
- (void)updateNSUserDefaults
{
    ...
    [SharedObject sharedObject].isProUser = [[NSUserDefaults standardUserDefaults] boolForKey:@"IsProUser"];
    
    NSLog(@"isProUser: %d", [SharedObject sharedObject].isProUser);
